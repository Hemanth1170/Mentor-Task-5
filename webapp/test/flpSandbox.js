		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commindsetappsproject5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetappsproject5-display": {
								"semanticObject": "commindsetappsproject5",
								"action": "display",
								"description": "Smart form filling fiori App",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.apps.project5",
									"url": sap.ui.require.toUrl("com/mindset/apps/project5")
								}
							}
						}
					}
